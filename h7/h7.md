...
Nexa-Security sekä Proove Security ovat täsmälleen identtisiä. Yhteneväisyyksiä näissä KlikAanKlikUit-Switch:n kanssa on 
- Kaikissa sama House code / ID
- Channel
- State / command OFF
...
Sama errori kuin aikaisemmin. Tällä hektellä tuntuu että juoksen vain hännän perässä ympyrää.

Tässä vaiheessa otin vain käyttöön aikaisemmin asentamani Windows 11 virtuaalikoneen ja asensin ja latasin suoraan URH.exe tiedoston URH githubista. Nyt sain ainaskin avattua URH:n. Saa nähdä toimiiko seuraavassa tehtävässä.
